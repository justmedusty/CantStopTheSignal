...
enum class Length(val value: Long) {
    ...
    MAX_CONVERSATION_MESSAGE_LIMIT(50), // We will give a larger value here since heavily paginated conversations will not be very nice with the design we have
...
enum class ThymeLeafMapKeys(val value: String) {
    ...
    SORT_ORDER_LIKED_BY_ME("liked_by_me"),
    SORT_ORDER_DISLIKED_BY_ME("disliked_by_me"),
